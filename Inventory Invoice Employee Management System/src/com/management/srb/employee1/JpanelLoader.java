...
public class JpanelLoader {
   ...
   public  void jPanelLoader(JPanel EmpMainForm,JPanel setPanel){
      EmpMainForm.removeAll();
     
        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(EmpMainForm);
        EmpMainForm.setLayout(layout);
